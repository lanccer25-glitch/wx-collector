...
export const batchRefreshStats = () => {
  return http.post<{code: number, message: string, data: any}>(`/wx/articles/batch_refresh_stats`)
}

export const getBatchStatsStatus = () => {
  return http.get<{code: number, data: any}>(`/wx/articles/batch_refresh_stats/status`)
}
...
export const notionSyncMp = (mp_id: string) => {
  return http.post<{code: number, message: string, data: any}>(`/wx/articles/notion_sync_mp`, null, {
    params: { mp_id }
  })
}

  ...
  <a-layout class="app-container">
    ...
    <a-layout-header class="app-header" v-if="route.path !== '/login'">
      <div class="header-left">
        <div class="logo">
          <img :src="logo" alt="avatar" :width="44" style="margin-right:0.8rem; border-radius:50%; object-fit:cover; width:44px; height:44px;">
...
const appTitle = computed(() => import.meta.env.VITE_APP_TITLE || '好D公众号订阅')
...
onMounted(async () => {
  // wait for router (incl. auto-login) before calling APIs
